...
/**
 * OfferFileInner Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OfferFileInner implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OfferFile_inner';
     ...
     * Sets url
     *
     * @param string $url The URL of the document to be sent as a coverage file on the acquisition process. This field is only required if `content` is not filled.  ----  URL do documento a ser enviado na remessa como lastro. Este campo é obrigatório somente se `content` não estiver preenchido.
     *
     * @return $this
     */
     ...
     * Sets content
     *
     * @param string $content Content of the document to be sent as a coverage file on the acquisition process. Encoded in `base64`. (This field is only required if `url` is not filled).  ----  Conteúdo do documento a ser enviado na remessa como lastro. Codificado em `base64`. (Não é necessário informar o campo url caso esse esteja preenchido).
     *
     * @return $this
     */
