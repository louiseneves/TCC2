...
/**
 * SellerNaturalPerson Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SellerNaturalPerson implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SellerNaturalPerson';
    ...
    protected static $swaggerTypes = [
        ...
        'bank_accounts' => '\Swagger\Client\Model\OneOfSellerNaturalPersonBankAccountsItems[]',
        'representatives' => '\Swagger\Client\Model\SellerRepresentativeNaturalPerson[]',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['government_id'] = isset($data['government_id']) ? $data['government_id'] : '31228126062';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['profession'] === null) {
            $invalidProperties[] = "'profession' can't be null";
        }
        if ($this->container['isolated_signature'] === null) {
            $invalidProperties[] = "'isolated_signature' can't be null";
        }
        if ($this->container['endorsement_signature'] === null) {
            $invalidProperties[] = "'endorsement_signature' can't be null";
        }
        if ($this->container['assignment_term_signature'] === null) {
            $invalidProperties[] = "'assignment_term_signature' can't be null";
        }
     ...
     * Sets government_id
     *
     * @param string $government_id The CPF of the seller.
     *
     * @return $this
     */
     ...
     * Gets bank_accounts
     *
     * @return \Swagger\Client\Model\OneOfSellerNaturalPersonBankAccountsItems[]
     */
     ...
     * Sets bank_accounts
     *
     * @param \Swagger\Client\Model\OneOfSellerNaturalPersonBankAccountsItems[] $bank_accounts bank_accounts
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\SellerRepresentativeNaturalPerson[]
     */
     ...
     *
     * @param \Swagger\Client\Model\SellerRepresentativeNaturalPerson[] $representatives representatives
     *
     * @return $this
     */
