...
class AuthenticationApi
{
     ...
     *
     * @param  \Swagger\Client\Model\OauthTokenBody $body body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\InlineResponse200
     */
    public function oauthTokenPost($body = null)
    {
        list($response) = $this->oauthTokenPostWithHttpInfo($body);
        return $response;
    }
     ...
     * EN: Creates a new access token. | PT: Cria um novo token de acesso.
     *
     * @param  \Swagger\Client\Model\OauthTokenBody $body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\InlineResponse200, HTTP status code, HTTP response headers (array of strings)
     */
    public function oauthTokenPostWithHttpInfo($body = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse200';
        $request = $this->oauthTokenPostRequest($body);
     ...
     */
    public function oauthTokenPostAsync($body = null)
    {
        return $this->oauthTokenPostAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function oauthTokenPostAsyncWithHttpInfo($body = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse200';
        $request = $this->oauthTokenPostRequest($body);
     ...
     */
    protected function oauthTokenPostRequest($body = null)
    {
